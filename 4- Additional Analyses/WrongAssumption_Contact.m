...
load WorkspacePT_Contact.mat %This is the true scenario
...
load WorkspaceST_Contact.mat % This is the assumed scenario
...
load WorkspacePN_Contact.mat %This is the true scenario
if true %Optimal 10% Drug 
ts=ts10;
...
%Comment below to see that the Deltas are equal to zero
load WorkspaceSN_Contact.mat % This is the assumed scenario
if true %Optimal 10% Drug, renaming everything assuming wrong scenario
S1=S1s10;
E1=E1s10;    
I1=I1s10;    
...
load WorkspaceST_Contact.mat %This is the true scenario
if true %Optimal 10% Drug 
ts=ts10;
...
%Comment below to see that the Deltas are equal to zero
load WorkspacePT_Contact.mat % This is the assumed scenario
if true %Optimal 10% Drug, renaming everything assuming wrong scenario
S1=S1s10;
E1=E1s10;    
I1=I1s10;    
...
load WorkspaceSN_Contact.mat %This is the true scenario
if true %Optimal 10% Drug 
ts=ts10;
...
%Comment below to see that the Deltas are equal to zero
load WorkspacePN_Contact.mat % This is the assumed scenario
if true %Optimal 10% Drug, renaming everything assuming wrong scenario
S1=S1s10;
E1=E1s10;    
I1=I1s10;    
...
%sgtitle({'Cross: wrong about immunity length; Circle: wrong about SIP','Star: wrong about both; Triangle: Ad Hoc','Blue: Perm. and SIP is true','Green: Perm and no SIP is true','Red: Temporary and SIP is true','Black: Temporary and no SIP is true'})
   ...
   saveas(gcf,'WrongAssumption_Vaccines10_ContactRate.png'); hold off
end
